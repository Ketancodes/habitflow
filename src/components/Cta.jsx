    ...
    <>
      <section className="w-full py-6">
        <div className="text-center">
          ...
          <button
            className=" mt-8 inline-flex items-center justify-center h-12 px-6 text-base font-medium text-white rounded-lg bg-[#4f46e5] shadow-md transition-all duration-200  
