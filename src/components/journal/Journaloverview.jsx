    ...
    <div className="mt-6 flex justify-center">
      <div className="relative w-[94%] overflow-hidden rounded-3xl border border-[#30313d] bg-[#171820] px-8 py-7">
        <div className="relative z-10">
          ...
          <div className="mt-8 grid w-[68%] grid-cols-4 divide-x divide-[#30313d]">
            ...
            <div className="flex items-center gap-4 px-6">
              <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-[#ff5578]/12 text-[#ff6b8a]">
                <Flame size={27} />
              </div>
              <div>
          ...
          <div className="mt-7 flex w-[68%] items-center gap-5 border-t border-[#30313d] pt-5">
